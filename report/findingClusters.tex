...
\begin{algorithm}
\begin{algorithmic}
\STATE Define: $timeThreshold = $ A threshold for how long our histogram is.
\STATE Define: $exampleHists = $ The histograms of the behavior examples
\FOR{$i = 1 + timeThreshold$ \TO $pointsInHistogram$}
    \STATE $currentHists \gets getHistograms(i-timeThreshold, i+timeThreshold)$
    \STATE $histogramValues(i) \gets \Sigma \left| currentHists - exampleHists \right|$\\
\ENDFOR
