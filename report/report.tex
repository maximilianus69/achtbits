...
\usepackage{subfig} % has to be loaded after caption to prevent clash
...
remains troublesome to annotate data point by point. The goal of this project
is to find and classify clusters of the data. In order to do this we 
found a method to cluster data using histograms and we created an
annotation tool to easily annotate clustered data points.
\end{abstract}
